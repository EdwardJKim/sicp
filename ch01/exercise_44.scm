; Exercse 1.44: The idea of smoothing a function is an important concept in
...
; of f(x−dx), f(x), and f(x+dx). Write a procedure smooth that takes as input a
